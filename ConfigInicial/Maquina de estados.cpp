...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion maquina de estados_ Calles Cedeño Andros Gael", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Modelo del perro seccionado del cual guardamos en la matriz temporal la posicion y la rotacion del cuerpo para que sea el padre
		// Posteriormente le pasamos esta informacion a las demas partes para que estos si es que modificamos el cuerpo se muevan o roten con el
		//Body
